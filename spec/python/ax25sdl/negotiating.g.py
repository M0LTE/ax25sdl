...
MANAGEMENT_DATA_LINK_NEGOTIATING = StatePage(
    ...
    transitions=(
        TransitionSpec(
            ...
            actions=(
                ...
                ActionStep(verb="MDL_NEGOTIATE_confirm", kind=ActionKind.SIGNAL_UPPER),
            ),
            next="Ready",
        ...
        TransitionSpec(
            ...
            guard="not F_eq_1",
            actions=(
                ActionStep(verb="MDL_ERROR_indicate_D", kind=ActionKind.SIGNAL_UPPER),
            ),
            next="Negotiating",
        ...
        TransitionSpec(
            ...
            guard="RC_eq_NM201",
            actions=(
                ActionStep(verb="MDL_ERROR_indicate_C", kind=ActionKind.SIGNAL_UPPER),
            ),
            next="Ready",
