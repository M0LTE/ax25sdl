    ...
    transitions=(
        ...
        TransitionSpec(
            ...
            actions=(
                ...
                ActionStep(verb="LM-RELEASE Request", kind=ActionKind.SIGNAL_LOWER),
            ),
            next="Connected",
            notes="",
            references=(),
        ...
        TransitionSpec(
            ...
            actions=(
                ...
                ActionStep(verb="LM-DATA Request", kind=ActionKind.SIGNAL_LOWER),
                ActionStep(verb="Stop T3", kind=ActionKind.PROCESSING),
                ActionStep(verb="Start T1", kind=ActionKind.PROCESSING),
                ActionStep(verb="Clear Acknowledge Pending", kind=ActionKind.PROCESSING),
            ),
        ...
        TransitionSpec(
            ...
            actions=(
                ...
                ActionStep(verb="DL-DATA Indication", kind=ActionKind.SIGNAL_UPPER),
                ActionStep(verb="LM-SEIZE Request", kind=ActionKind.SIGNAL_LOWER),
