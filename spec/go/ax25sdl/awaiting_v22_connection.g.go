...
// DataLinkAwaitingConnection22 holds the SDL transitions for the
// AwaitingConnection22 state of the data_link machine. Source: ax.25.2.2.4_Oct_25, figure figc4.6.
var DataLinkAwaitingConnection22 = StatePage{
	Machine: "data_link",
	State:   "AwaitingConnection22",
	Source:  SdlSource{Spec: "ax.25.2.2.4_Oct_25", Figure: "figc4.6", URL: "https://raw.githubusercontent.com/packethacking/ax25spec/main/doc/media/figc4.6.png"},
	Transitions: []TransitionSpec{
		...
		},
		{
			...
			Actions: []ActionStep{
				...
				{Verb: "MDL_NEGOTIATE_request", Kind: InternalOut},
			},
			Next:  "Connected",
