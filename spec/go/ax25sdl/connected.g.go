	...
	Transitions: []TransitionSpec{
		...
		},
		{
			...
			Actions: []ActionStep{
				...
				{Verb: "Check I Frame Acknowledged", Kind: Subroutine},
			},
			Next:       "Connected",
			Notes:      "",
			References: []ImplementationReference{},
		...
		},
		{
			...
			Actions: []ActionStep{
				...
				{Verb: "LM-RELEASE Request", Kind: SignalLower},
			},
			Next:       "Connected",
			Notes:      "",
			References: []ImplementationReference{},
		...
		},
		{
			...
			Actions: []ActionStep{
				...
				{Verb: "LM-DATA Request", Kind: SignalLower},
				{Verb: "Stop T3", Kind: Processing},
				{Verb: "Start T1", Kind: Processing},
				{Verb: "Clear Acknowledge Pending", Kind: Processing},
			},
		...
		},
		{
			...
			Actions: []ActionStep{
				...
				{Verb: "DL-DATA Indication", Kind: SignalUpper},
				{Verb: "LM-SEIZE Request", Kind: SignalLower},
