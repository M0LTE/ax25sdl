...
// ManagementDataLinkNegotiating holds the SDL transitions for the
// Negotiating state of the management_data_link machine. Source: ax.25.2.2.4_Oct_25, figure figc5.2.
var ManagementDataLinkNegotiating = StatePage{
	Machine: "management_data_link",
	State:   "Negotiating",
	Source:  SdlSource{Spec: "ax.25.2.2.4_Oct_25", Figure: "figc5.2", URL: "https://raw.githubusercontent.com/packethacking/ax25spec/main/doc/ax.25.2.2.4_Oct_25.md"},
	Transitions: []TransitionSpec{
		{
			...
			Actions: []ActionStep{
				...
				{Verb: "MDL_NEGOTIATE_confirm", Kind: SignalUpper},
			},
			Next:  "Ready",
			...
			References: []ImplementationReference{
				{Source: "spec_prose", Cite: "§C5.3 ¶3", Quote: "If the other station is using version 2.2 or better, it will respond with an XID response.", Path: "", Function: "", Line: 0, Note: ""},
				{Source: "spec_prose", Cite: "§6.3.2 ¶7", Quote: "The distant TNC chooses to accept the values offered, or other acceptable values, and places these values in the XID response. Both TNCs set up based on the values used in the XID response.", Path: "", Function: "", Line: 0, Note: ""},
				{Source: "spec_prose", Cite: "§5.1", Quote: "MDL-NEGOTIATE Confirm. The Management Data-link State Machine uses this primitive to notify the Layer 3 entity that notification/negotiation is complete.", Path: "", Function: "", Line: 0, Note: ""},
			},
			Loops: []LoopRange{},
		},
		{
			...
			Guard: "not F_eq_1",
			Actions: []ActionStep{
				{Verb: "MDL_ERROR_indicate_D", Kind: SignalUpper},
			},
			Next:  "Negotiating",
			...
			References: []ImplementationReference{
				{Source: "spec_prose", Cite: "§C5.3 Error Codes", Quote: "D — XID response without F=1.", Path: "", Function: "", Line: 0, Note: ""},
			},
			Loops: []LoopRange{},
		},
		{
			...
			References: []ImplementationReference{
				...
				{Source: "spec_prose", Cite: "§C5.3 ¶3", Quote: "If the other station is using a version of AX.25 earlier than 2.2, it will respond with an FRMR of the XID command, and the default version 2.0 parameters will be used.", Path: "", Function: "", Line: 0, Note: ""},
			},
			Loops: []LoopRange{},
		},
		{
			...
			Guard: "RC_eq_NM201",
			Actions: []ActionStep{
				{Verb: "MDL_ERROR_indicate_C", Kind: SignalUpper},
			},
			Next:  "Ready",
			...
			References: []ImplementationReference{
				{Source: "spec_prose", Cite: "§C5.3 Error Codes", Quote: "C — Management retry limit exceeded.", Path: "", Function: "", Line: 0, Note: ""},
				{Source: "spec_prose", Cite: "§C5.3 Variables", Quote: "RC — Retry count. NM201 — Maximum number of retries of the XID command.", Path: "", Function: "", Line: 0, Note: ""},
			},
			Loops: []LoopRange{},
		},
		{
			...
			References: []ImplementationReference{
				{Source: "spec_prose", Cite: "§C5.3 Variables", Quote: "RC — Retry count. NM201 — Maximum number of retries of the XID command.", Path: "", Function: "", Line: 0, Note: ""},
				{Source: "spec_prose", Cite: "§6.3.1 ¶2", Quote: "If the distant TNC doesn't respond before T1 times out, the originating TNC resends the SABM frame and starts T1 running again. The originating TNC tries to establish a connection until it has tried unsuccessfully N2 times.", Path: "", Function: "", Line: 0, Note: ""},
			},
			Loops: []LoopRange{},
		},
	},
