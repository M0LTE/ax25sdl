 ...
 */
export const ManagementDataLinkNegotiating: StatePage = {
  machine: "management_data_link",
  state: "Negotiating",
  source: { spec: "ax.25.2.2.4_Oct_25", figure: "figc5.2", url: "https://raw.githubusercontent.com/packethacking/ax25spec/main/doc/ax.25.2.2.4_Oct_25.md" },
  transitions: [
    {
      ...
      actions: [
        ...
        { verb: "MDL_NEGOTIATE_confirm", kind: "signal_upper" },
      ],
      next: "Ready",
