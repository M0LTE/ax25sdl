 ...
 */
export const ManagementDataLinkReady: StatePage = {
  machine: "management_data_link",
  state: "Ready",
  source: { spec: "ax.25.2.2.4_Oct_25", figure: "figc5.1", url: "https://raw.githubusercontent.com/packethacking/ax25spec/main/doc/ax.25.2.2.4_Oct_25.md" },
  transitions: [
    {
