  ...
  transitions: [
    ...
    },
    {
      ...
      actions: [
        ...
        { verb: "DL-ERROR Indication (F)", kind: "signal_upper" },
        { verb: "discard_I_frame_queue", kind: "processing" },
        { verb: "DL-CONNECT Indication", kind: "signal_upper" },
        { verb: "Stop T1", kind: "processing" },
        { verb: "Start T3", kind: "processing" },
        { verb: "V(a) := 0", kind: "processing" },
        { verb: "V(s) := 0", kind: "processing" },
    ...
    },
    {
      ...
      actions: [
        ...
        { verb: "LM-RELEASE Request", kind: "signal_lower" },
      ],
      next: "Connected",
      notes: "",
      references: [],
    ...
    },
    {
      ...
      actions: [
        ...
        { verb: "LM-DATA Request", kind: "signal_lower" },
        { verb: "Stop T3", kind: "processing" },
        { verb: "Start T1", kind: "processing" },
        { verb: "Clear Acknowledge Pending", kind: "processing" },
      ],
    ...
    },
    {
      ...
      actions: [
        ...
        { verb: "DL-DATA Indication", kind: "signal_upper" },
        { verb: "LM-SEIZE Request", kind: "signal_lower" },
