...
public static class DataLink_AwaitingConnection22
{
    ...
    public static IReadOnlyList<TransitionSpec> Transitions { get; } = new TransitionSpec[]
    {
        ...
        new TransitionSpec(
            ...
            On: "DM_received",
            Guard: "F_eq_1",
            Actions: new ActionStep[] { new ActionStep("discard_I_frame_queue", ActionKind.Processing), new ActionStep("DL_DISCONNECT_indication", ActionKind.SignalUpper), new ActionStep("stop_T1", ActionKind.Processing) },
            Next: "Disconnected",
        ...
        new TransitionSpec(
            ...
            On: "FRMR_received",
            Guard: null,
            Actions: new ActionStep[] { new ActionStep("SRT := Initial Default", ActionKind.Processing), new ActionStep("T1V := 2 * SRT", ActionKind.Processing), new ActionStep("Establish_Data_Link", ActionKind.Subroutine), new ActionStep("set_layer_3_initiated", ActionKind.Processing), new ActionStep("set_version_2_0", ActionKind.Processing) },
            Next: "AwaitingConnection",
