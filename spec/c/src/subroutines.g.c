...
// spec-sdl/v2.2-errata/data-link/yaml/subroutines.sdl.yaml. DO NOT EDIT. Run
// `dotnet run --project codegen/src/Packet.Sdl.CodeGen` to regenerate.

#include "ax25sdl.h"

static const ActionStep
    data_link_subroutines_set_version_2_2_t01_set_version_2_2_actions[] = {
...
static const ActionStep
    data_link_subroutines_u_i_check_t01_ui_check_no_actions[] = {
...
static const ActionStep
    data_link_subroutines_u_i_check_t03_ui_check_yes_no_actions[] = {
        {.verb = "DL-ERROR Indication (K)", .kind = AX25SDL_KIND_SIGNAL_UPPER},
};

static const ActionStep
    data_link_subroutines_select_t1_t01_select_t1_yes_actions[] = {
...
static const ActionStep
    data_link_subroutines_select_t1_t03_select_t1_no_yes_actions[] = {
        {.verb = "Next T1 := (RC*0.25)+SRT*2", .kind = AX25SDL_KIND_PROCESSING},
};

static const ActionStep
    data_link_subroutines_set_version_2_0_t01_set_version_2_0_actions[] = {
        {.verb = "Set Half Duplex", .kind = AX25SDL_KIND_PROCESSING},
...
static const ActionStep
    data_link_subroutines_check_i_frame_acknowledged_t01_check_i_frame_acknowledged_yes_yes_actions
        [] = {
...
static const ActionStep
    data_link_subroutines_check_i_frame_acknowledged_t02_check_i_frame_acknowledged_yes_no_actions
        [] = {
            {.verb = "V(a) := N(r)", .kind = AX25SDL_KIND_PROCESSING},
            {.verb = "Stop T3", .kind = AX25SDL_KIND_PROCESSING},
            {.verb = "Start T1", .kind = AX25SDL_KIND_PROCESSING},
...
static const ActionStep
    data_link_subroutines_check_i_frame_acknowledged_t03_check_i_frame_acknowledged_no_yes_actions
        [] = {
            {.verb = "V(a) := N(r)", .kind = AX25SDL_KIND_PROCESSING},
...
static const ActionStep
    data_link_subroutines_check_i_frame_acknowledged_t05_check_i_frame_acknowledged_no_no_no_actions
        [] = {
            {.verb = "V(a) := N(r)", .kind = AX25SDL_KIND_PROCESSING},
            {.verb = "Start T1", .kind = AX25SDL_KIND_PROCESSING},
};
...
static const ActionStep
    data_link_subroutines_clear_exception_conditions_t01_clear_exception_conditions_actions
        [] = {
            ...
            {.verb = "Clear Sreject Condition",
             .kind = AX25SDL_KIND_PROCESSING},
            {.verb = "Clear Acknowledge Pending",
             .kind = AX25SDL_KIND_PROCESSING},
            {.verb = "Discard I Queue Entries",
             .kind = AX25SDL_KIND_PROCESSING},
};

static const ActionStep
    data_link_subroutines_n_r_error_recovery_t01_n_r_error_recovery_actions[] =
        {
            {.verb = "DL-ERROR Indication (J)",
             .kind = AX25SDL_KIND_SIGNAL_UPPER},
            {.verb = "Establish_Data_Link", .kind = AX25SDL_KIND_SUBROUTINE},
            {.verb = "Clear Layer 3 Initiated",
             .kind = AX25SDL_KIND_PROCESSING},
};

static const ActionStep
    data_link_subroutines_transmit_enquiry_t01_transmit_enquiry_no_actions[] = {
        {.verb = "P := 1", .kind = AX25SDL_KIND_PROCESSING},
...
static const ActionStep
    data_link_subroutines_transmit_enquiry_t02_transmit_enquiry_yes_actions[] =
        {
            {.verb = "P := 1", .kind = AX25SDL_KIND_PROCESSING},
            {.verb = "N(r) := V(r)", .kind = AX25SDL_KIND_PROCESSING},
...
static const ActionStep
    data_link_subroutines_enquiry_response_t02_enquiry_response_yes_no_yes_yes_yes_actions
        [] = {
            {.verb = "N(r) := V(r)", .kind = AX25SDL_KIND_PROCESSING},
...
static const ActionStep
    data_link_subroutines_enquiry_response_t03_enquiry_response_yes_no_yes_yes_no_actions
        [] = {
            {.verb = "N(r) := V(r)", .kind = AX25SDL_KIND_PROCESSING},
            {.verb = "DL-ERROR Indication (add)",
             .kind = AX25SDL_KIND_SIGNAL_UPPER},
...
static const ActionStep
    data_link_subroutines_enquiry_response_t04_enquiry_response_yes_no_yes_no_yes_actions
        [] = {
            {.verb = "N(r) := V(r)", .kind = AX25SDL_KIND_PROCESSING},
            {.verb = "SREJ", .kind = AX25SDL_KIND_SIGNAL_LOWER},
            {.verb = "RR Response", .kind = AX25SDL_KIND_SIGNAL_LOWER},
...
static const ActionStep
    data_link_subroutines_enquiry_response_t05_enquiry_response_yes_no_yes_no_no_actions
        [] = {
            {.verb = "N(r) := V(r)", .kind = AX25SDL_KIND_PROCESSING},
            {.verb = "RR Response", .kind = AX25SDL_KIND_SIGNAL_LOWER},
            {.verb = "Clear Acknowledge Pending",
