...
static const ActionStep
    data_link_awaiting_connection_t02_disc_received_actions[] = {
...
static const ActionStep
    data_link_awaiting_connection_t04_ua_received_yes_no_yes_actions[] = {
        {.verb = "Stop T1", .kind = AX25SDL_KIND_PROCESSING},
        {.verb = "Start T3", .kind = AX25SDL_KIND_PROCESSING},
        {.verb = "V(s) := 0", .kind = AX25SDL_KIND_PROCESSING},
        {.verb = "V(a) := 0", .kind = AX25SDL_KIND_PROCESSING},
...
static const ActionStep
    data_link_awaiting_connection_t04_ua_received_yes_no_no_actions[] = {
...
static const ActionStep
    data_link_awaiting_connection_t05_t1_expiry_no_actions[] = {
...
static const ActionStep
    data_link_awaiting_connection_t07_dl_connect_request_actions[] = {
        {.verb = "Discard Queue", .kind = AX25SDL_KIND_PROCESSING},
        {.verb = "Set Layer 3 Initiated", .kind = AX25SDL_KIND_PROCESSING},
};

static const ActionStep
    data_link_awaiting_connection_t08_dl_unit_data_request_actions[] = {
...
static const ActionStep
    data_link_awaiting_connection_t12_ui_received_yes_actions[] = {
        {.verb = "UI Check", .kind = AX25SDL_KIND_SUBROUTINE},
        {.verb = "DM (F = 1)", .kind = AX25SDL_KIND_SIGNAL_LOWER},
};

static const ActionStep
    data_link_awaiting_connection_t12_ui_received_no_actions[] = {
        {.verb = "UI Check", .kind = AX25SDL_KIND_SUBROUTINE},
};

static const ActionStep
    data_link_awaiting_connection_t13_control_field_error_actions[] = {
        {.verb = "DL-ERROR Indication (L)", .kind = AX25SDL_KIND_SIGNAL_UPPER},
};

static const ActionStep
    data_link_awaiting_connection_t14_info_not_permitted_in_frame_actions[] = {
        {.verb = "DL-ERROR Indication (M)", .kind = AX25SDL_KIND_SIGNAL_UPPER},
};

static const ActionStep
    data_link_awaiting_connection_t15_u_or_s_frame_length_error_actions[] = {
        {.verb = "DL-ERROR Indication (N)", .kind = AX25SDL_KIND_SIGNAL_UPPER},
};

static const ActionStep
    data_link_awaiting_connection_t16_sabm_received_actions[] = {
        {.verb = "F := P", .kind = AX25SDL_KIND_PROCESSING},
        {.verb = "UA", .kind = AX25SDL_KIND_SIGNAL_LOWER},
};

static const ActionStep
    data_link_awaiting_connection_t17_sabme_received_actions[] = {
        {.verb = "F := P", .kind = AX25SDL_KIND_PROCESSING},
        {.verb = "DM", .kind = AX25SDL_KIND_SIGNAL_LOWER},
};
