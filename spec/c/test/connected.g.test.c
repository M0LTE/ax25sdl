...
static int test_t01_dl_disconnect_request(void) {
    ...
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t01_dl_disconnect_request") == 0) {
...
static int test_t02_dl_data_request(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t02_dl_data_request") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->actions[0].verb, "Push on I Frame Queue (note: word order?)", "actions[0].verb");
...
static int test_t03_i_frame_pops_off_queue_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t03_i_frame_pops_off_queue_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t03_i_frame_pops_off_queue_no_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t03_i_frame_pops_off_queue_no_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t03_i_frame_pops_off_queue_no_no_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t03_i_frame_pops_off_queue_no_no_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t03_i_frame_pops_off_queue_no_no_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t03_i_frame_pops_off_queue_no_no_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t04_dl_unit_data_request(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t04_dl_unit_data_request") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t05_dl_flow_off_request_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t05_dl_flow_off_request_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t05_dl_flow_off_request_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t05_dl_flow_off_request_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t06_dl_flow_on_request_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t06_dl_flow_on_request_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t06_dl_flow_on_request_yes_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t06_dl_flow_on_request_yes_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t06_dl_flow_on_request_yes_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t06_dl_flow_on_request_yes_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t07_dl_connect_request_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t07_dl_connect_request_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t07_dl_connect_request_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t07_dl_connect_request_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t08_all_other_primitives__from_upper_layer(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t08_all_other_primitives__from_upper_layer") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t09_control_field_error_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t09_control_field_error_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t09_control_field_error_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t09_control_field_error_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t10_info_not_permitted_in_frame_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t10_info_not_permitted_in_frame_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t10_info_not_permitted_in_frame_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t10_info_not_permitted_in_frame_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t11_u_or_s_frame_length_error_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t11_u_or_s_frame_length_error_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t11_u_or_s_frame_length_error_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t11_u_or_s_frame_length_error_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t14_sabm_received_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t14_sabm_received_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t14_sabm_received_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t14_sabm_received_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t15_sabme_received_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t15_sabme_received_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t15_sabme_received_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t15_sabme_received_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t16_frmr_received_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t16_frmr_received_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t16_frmr_received_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t16_frmr_received_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t17_ua_received_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t17_ua_received_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t17_ua_received_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t17_ua_received_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t18_ui_received_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t18_ui_received_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t18_ui_received_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t18_ui_received_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t19_disc_received(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t19_disc_received") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t21_rr_received_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t21_rr_received_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT(t->actions[0].kind == AX25SDL_KIND_PROCESSING, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "Check Need For Response", "actions[1].verb");
    ASSERT(t->actions[1].kind == AX25SDL_KIND_SUBROUTINE, "actions[1].kind");
...
static int test_t21_rr_received_no_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t21_rr_received_no_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t21_rr_received_no_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t21_rr_received_no_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t22_rnr_received_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t22_rnr_received_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t22_rnr_received_no_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t22_rnr_received_no_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t22_rnr_received_no_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t22_rnr_received_no_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t23_lm_seize_confirm_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t23_lm_seize_confirm_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t23_lm_seize_confirm_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t23_lm_seize_confirm_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t24_srej_received_yes_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t24_srej_received_yes_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->actions[6].verb, "Push Old I Frame N(r) on Queue", "actions[6].verb");
    ...
    ASSERT(t->actions[9].kind == AX25SDL_KIND_PROCESSING, "actions[9].kind");
    ASSERT_STREQ(t->actions[10].verb, "Clear Acknowledge Pending", "actions[10].verb");
    ASSERT(t->actions[10].kind == AX25SDL_KIND_PROCESSING, "actions[10].kind");
    return 0;
}
...
static int test_t24_srej_received_yes_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t24_srej_received_yes_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->actions[5].verb, "Push Old I Frame N(r) on Queue", "actions[5].verb");
...
static int test_t24_srej_received_no_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t24_srej_received_no_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t24_srej_received_no_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t24_srej_received_no_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t25_rej_received_no_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t25_rej_received_no_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t25_rej_received_no_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t25_rej_received_no_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t25_rej_received_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t25_rej_received_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t26_i_received_yes_no_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_no_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->next, "AwaitingConnection", "next");
    ASSERT_STREQ(t->guard, "command and not info_field_length_le_N1_and_content_is_octet_aligned and not version_2_2", "guard");
    ASSERT(t->actions_len == 3, "actions count");
...
static int test_t26_i_received_yes_no_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_no_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "AwaitingV22Connection", "next");
    ASSERT_STREQ(t->guard, "command and not info_field_length_le_N1_and_content_is_octet_aligned and version_2_2", "guard");
    ASSERT(t->actions_len == 3, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "DL-ERROR Indication (O)", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SIGNAL_UPPER, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "Establish_Data_Link", "actions[1].verb");
...
static int test_t26_i_received_yes_yes_no_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_yes_no_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "AwaitingConnection", "next");
    ASSERT_STREQ(t->guard, "command and info_field_length_le_N1_and_content_is_octet_aligned and not va_le_nr_le_vs and not version_2_2", "guard");
    ASSERT(t->actions_len == 1, "actions count");
...
static int test_t26_i_received_yes_yes_no_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_yes_no_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "AwaitingV22Connection", "next");
    ASSERT_STREQ(t->guard, "command and info_field_length_le_N1_and_content_is_octet_aligned and not va_le_nr_le_vs and version_2_2", "guard");
    ASSERT(t->actions_len == 1, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "N(r) Error Recovery", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    return 0;
...
static int test_t26_i_received_yes_yes_yes_no_yes_no_no_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_yes_yes_no_yes_no_no_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t26_i_received_yes_yes_yes_no_yes_no_no_no not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_length_le_N1_and_content_is_octet_aligned and va_le_nr_le_vs and not own_receiver_busy and ns_eq_vr and not P_eq_1 and not ack_pending", "guard");
    ...
    ASSERT_STREQ(t->actions[6].verb, "set_acknowledge_pending", "actions[6].verb");
    ASSERT(t->actions[6].kind == AX25SDL_KIND_PROCESSING, "actions[6].kind");
    return 0;
}

static int test_t26_i_received_yes_yes_yes_no_yes_no_no_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_yes_yes_no_yes_no_no_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t26_i_received_yes_yes_yes_no_yes_no_no_yes not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_length_le_N1_and_content_is_octet_aligned and va_le_nr_le_vs and not own_receiver_busy and ns_eq_vr and not P_eq_1 and ack_pending", "guard");
    ASSERT(t->actions_len == 5, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "V(r) := V(r) + 1", "actions[1].verb");
...
static int test_t26_i_received_yes_yes_yes_no_yes_no_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_yes_yes_no_yes_no_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_length_le_N1_and_content_is_octet_aligned and va_le_nr_le_vs and not own_receiver_busy and ns_eq_vr and P_eq_1", "guard");
...
static int test_t26_i_received_yes_yes_yes_no_no_yes_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_yes_yes_no_no_yes_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t26_i_received_yes_yes_yes_no_no_yes_yes not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_length_le_N1_and_content_is_octet_aligned and va_le_nr_le_vs and not own_receiver_busy and not ns_eq_vr and reject_exception and P_eq_1", "guard");
    ASSERT(t->actions_len == 6, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
...
static int test_t26_i_received_yes_yes_yes_no_no_yes_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_yes_yes_no_no_yes_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t26_i_received_yes_yes_yes_no_no_yes_no not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_length_le_N1_and_content_is_octet_aligned and va_le_nr_le_vs and not own_receiver_busy and not ns_eq_vr and reject_exception and not P_eq_1", "guard");
    ASSERT(t->actions_len == 2, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "Discard Contents of I Frame", "actions[1].verb");
...
static int test_t26_i_received_yes_yes_yes_no_no_no_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_yes_yes_no_no_no_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_length_le_N1_and_content_is_octet_aligned and va_le_nr_le_vs and not own_receiver_busy and not ns_eq_vr and not reject_exception and not SREJ_enabled", "guard");
    ASSERT(t->actions_len == 7, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "Discard Contents of I Frame", "actions[1].verb");
...
static int test_t26_i_received_yes_yes_yes_no_no_no_yes_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_yes_yes_no_no_no_yes_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t26_i_received_yes_yes_yes_no_no_no_yes_yes not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_length_le_N1_and_content_is_octet_aligned and va_le_nr_le_vs and not own_receiver_busy and not ns_eq_vr and not reject_exception and SREJ_enabled and sreject_exception_gt_0", "guard");
    ASSERT(t->actions_len == 6, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ...
    ASSERT(t->actions[3].kind == AX25SDL_KIND_PROCESSING, "actions[3].kind");
    ASSERT_STREQ(t->actions[4].verb, "Increment Sreject Exception", "actions[4].verb");
    ASSERT(t->actions[4].kind == AX25SDL_KIND_PROCESSING, "actions[4].kind");
...
static int test_t26_i_received_yes_yes_yes_no_no_no_yes_no_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_yes_yes_no_no_no_yes_no_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t26_i_received_yes_yes_yes_no_no_no_yes_no_yes not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_length_le_N1_and_content_is_octet_aligned and va_le_nr_le_vs and not own_receiver_busy and not ns_eq_vr and not reject_exception and SREJ_enabled and not sreject_exception_gt_0 and ns_gt_vr_plus_1", "guard");
    ASSERT(t->actions_len == 8, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "Save Contents of I Frame", "actions[1].verb");
...
static int test_t26_i_received_yes_yes_yes_no_no_no_yes_no_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_yes_yes_no_no_no_yes_no_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t26_i_received_yes_yes_yes_no_no_no_yes_no_no not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_length_le_N1_and_content_is_octet_aligned and va_le_nr_le_vs and not own_receiver_busy and not ns_eq_vr and not reject_exception and SREJ_enabled and not sreject_exception_gt_0 and not ns_gt_vr_plus_1", "guard");
    ASSERT(t->actions_len == 6, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "Save Contents of I Frame", "actions[1].verb");
...
static int test_t26_i_received_yes_yes_yes_yes_yes(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_yes_yes_yes_yes") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_length_le_N1_and_content_is_octet_aligned and va_le_nr_le_vs and own_receiver_busy and P_eq_1", "guard");
    ASSERT(t->actions_len == 6, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "Discard Contents of I Frame", "actions[1].verb");
...
static int test_t26_i_received_yes_yes_yes_yes_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_yes_yes_yes_yes_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_length_le_N1_and_content_is_octet_aligned and va_le_nr_le_vs and own_receiver_busy and not P_eq_1", "guard");
    ASSERT(t->actions_len == 2, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "Discard Contents of I Frame", "actions[1].verb");
...
static int test_t26_i_received_no(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_i_received_no") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
int main(void) {
    ...
    rc |= test_t26_i_received_yes_yes_yes_no_yes_no_no_no();
    rc |= test_t26_i_received_yes_yes_yes_no_yes_no_no_yes();
    rc |= test_t26_i_received_yes_yes_yes_no_yes_no_yes();
    rc |= test_t26_i_received_yes_yes_yes_no_no_yes_yes();
    rc |= test_t26_i_received_yes_yes_yes_no_no_yes_no();
    rc |= test_t26_i_received_yes_yes_yes_no_no_no_no();
    rc |= test_t26_i_received_yes_yes_yes_no_no_no_yes_yes();
    rc |= test_t26_i_received_yes_yes_yes_no_no_no_yes_no_yes();
    rc |= test_t26_i_received_yes_yes_yes_no_no_no_yes_no_no();
